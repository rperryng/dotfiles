return {
  {
    ...
    config = function()
      ...
      -- https://github.com/chrisgrieser/nvim-various-textobjs/issues/93#issuecomment-2255437246
      local oldM = {}
      ...
      function oldM.multiCommentedLines(lookForwL)
