...
# Really just here as a reference to use as needed
# Originally collect from https://stackoverflow.com/a/28938235/3194316
...
ON_I_BLACK='\033[0;100m'   # Black
ON_I_RED='\033[0;101m'     # Red
ON_I_GREEN='\033[0;102m'   # Green
ON_I_YELLOW='\033[0;103m'  # Yellow
ON_I_BLUE='\033[0;104m'    # Blue
ON_I_PURPLE='\033[0;105m'  # Purple
ON_I_CYAN='\033[0;106m'    # Cyan
ON_I_WHITE='\033[0;107m'   # White
